      ...
      <div className="relative flex-1">
        <Menu.Button className="dropdown-btn w-full h-full flex flex-col justify-center items-center xl:items-start xl:pl-8">
          <div className="flex flex-col xl:flex-row items-center xl:gap-x-2 gap-y-2 xl:gap-y-0">
            ...
            <div className="text-[15px] uppercase font-bold">Select Horas</div>
          </div>
        ...
        <Menu.Items className="drodown-meu shadow-lg absolute -top-72 xl:top-[90px] left-1/2 xl:left-0 z-10 transform -translate-x-1/2 xl:translate-x-0 text-sm text-left w-full bg-white max-w-[332px] py-6 rounded-[10px]">
